                                ...
                                {activeTab === 'about' && (
                                    ...
                                    >
                                        <div className="flex flex-col items-center py-6 space-y-5">
                                            {/* Logo */}
                                            <img src="/logo.svg" className="w-16 h-16 drop-shadow-lg" alt="ClauSync Logo" />
                                            
                                            {/* App Name & Version */}
                                            <div className="text-center">
                                                <h3 className="text-base font-bold text-telegram-text">ClauSync</h3>
                                            ...
                                            <div className="text-center space-y-3">
                                                <div>
                                                    <p className="text-sm font-semibold text-telegram-text">ClauSync</p>
                                                </div>

                                                {/* GitHub Link */}
                                                <button
                                                    onClick={(e) => { e.preventDefault(); open('https://github.com/darkinlife71/clausync'); }}
