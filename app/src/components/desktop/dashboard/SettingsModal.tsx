                                ...
                                {activeTab === 'about' && (
                                    ...
                                    >
                                        <div className="flex flex-col items-center py-6 space-y-5">
                                            {/* Logo */}
                                            <img src="/logo.svg" className="w-16 h-16 drop-shadow-lg" alt="AuSync Logo" />
                                            
                                            {/* App Name & Version */}
                                            <div className="text-center">
                                                <h3 className="text-base font-bold text-telegram-text">AuSync</h3>
                                            ...
                                            <div className="text-center space-y-3">
                                                ...
                                                {/* GitHub Link */}
                                                <button
                                                    onClick={(e) => { e.preventDefault(); open('https://github.com/darkinlife71/ausync'); }}
                                                    className="flex items-center justify-center gap-1.5 text-xs text-telegram-primary hover:text-telegram-primary/80 transition-colors cursor-pointer"
                                                >
